# Ejemplos de Python - Tutorial SEA
...
- **Documentación oficial**: [docs.python.org](https://docs.python.org/es/3/)
- **PEP 8**: Guía de estilo para código Python
- **Comunidad**: Participa en foros y comunidades de Python en español



## 📄 Licencia

Este material forma parte del contenido académico de la asignatura Sistemas Embebidos Avanzados (SEA) del MUISE, UPV 2025. El contenido está disponible con fines educativos.
